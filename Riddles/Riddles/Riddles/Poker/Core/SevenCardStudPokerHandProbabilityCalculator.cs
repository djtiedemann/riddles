    ...
    public class SevenCardStudPokerHandProbabilityCalculator
    {
            ...
            switch (handType)
            {
                case HandType.HighCard:
                    ...
                    return (this._binomialTheoremCalculator
                        .CalculateBinomialCoefficient(numRanks, 7)
                    // remove the straights
                    - this.CalculateNumberOfWaysToGetAtLeastFiveConsecutiveRanksFromSevenDistinctRanks(numRanks))
                    ...
                    * numSuits
                    * Math.Pow(numSuits - 1, 2)
                    );
                case HandType.Pair:
                    // there are six ranks. Pick the six ranks
                    // remove straights
                    return (this._binomialTheoremCalculator
                        .CalculateBinomialCoefficient(numRanks, 6)
                        - this.CalculateNumberOfWaysToGetAtLeastFiveConsecutiveRanksFromSixDistinctRanks(numRanks)
                    )
                    ...
                    * (Math.Pow(numSuits, 5)
                        ...
                        - 2 * this._binomialTheoremCalculator
                            ...
                            * this._binomialTheoremCalculator
                            .CalculateBinomialCoefficient(numSuits - 1, 1)
                    );  
                case HandType.TwoPair: 
                    ...
                    return (this._binomialTheoremCalculator
                        ...
                        * this.CalculateNumberOfTwoPairHandsAvoidingFlushesGivenFiveRanks(numSuits)
                    // 2. 3 pairs and 1 single
                    // pick the 4 ranks. Straights and flushes are impossible
                    + this._binomialTheoremCalculator
                        .CalculateBinomialCoefficient(numRanks, 4)
                    ...
                    * Math.Pow(this._binomialTheoremCalculator
                        .CalculateBinomialCoefficient(numSuits, 2), 3)
                ...
                case HandType.ThreeOfAKind: 
                    ...
                    return (this._binomialTheoremCalculator
                        ...
                        * (Math.Pow(numSuits, 4) - 3);
                case HandType.Straight:
                    // straight can have 5, 6, or 7 distinct cards
                    // 1. 7 distinct cards
                    // start with the full set of straights of 7 distinct values
                    return this.CalculateNumberOfWaysToGetAtLeastFiveConsecutiveRanksFromSevenDistinctRanks(numRanks)
                        * (
                            ...
                            - this._binomialTheoremCalculator.CalculateBinomialCoefficient(7, 5)
                                * this._binomialTheoremCalculator
                                .CalculateBinomialCoefficient(numSuits, 1)
                                * Math.Pow(this._binomialTheoremCalculator
                                .CalculateBinomialCoefficient(numSuits - 1, 1), 2)
                        )
                    // 2. 6 distinct cards
                    ...
                    (this._binomialTheoremCalculator.CalculateBinomialCoefficient(6, 1) *
                        this._binomialTheoremCalculator.CalculateBinomialCoefficient(numSuits, 2) *
                        (Math.Pow(numSuits, 5)
                    ...
                    + (numRanks - 3)
                        * this._binomialTheoremCalculator.CalculateBinomialCoefficient(5, 1)
                        * this._binomialTheoremCalculator.CalculateBinomialCoefficient(numSuits, 3)
                        // pick the suits of the remaining 4 cards
                        // only a flush if they all match and match one of the suits of the triple
                        * (Math.Pow(numSuits, 4) - this._binomialTheoremCalculator
                ...
                case HandType.Flush:
                    ...
                    + this._binomialTheoremCalculator
                        ...
                        this._binomialTheoremCalculator
                            .CalculateBinomialCoefficient((numSuits-1) * numRanks
                            , 1)
                ...
                case HandType.FullHouse:
                    ...
                    this._binomialTheoremCalculator
                        .CalculateBinomialCoefficient(numRanks - 2, 2) *
                    ...
                    Math.Pow(this._binomialTheoremCalculator
                        .CalculateBinomialCoefficient(numSuits, 2), 2)
                    +
                    // For AAAKKKQ
                    ...
                    Math.Pow(this._binomialTheoremCalculator
                        .CalculateBinomialCoefficient(numSuits, 3), 2) *
                    // pick the suit of the card we have 1 of
                    this._binomialTheoremCalculator.CalculateBinomialCoefficient(numSuits, 1)
                    ;
                ...
                case HandType.FourOfAKind:
                    ...
                    this._binomialTheoremCalculator
                        .CalculateBinomialCoefficient(numSuits*numRanks - 4, 3);
                case HandType.StraightFlush:
                    ...
                    // lower card
                    this._binomialTheoremCalculator
                        .CalculateBinomialCoefficient(numSuits * numRanks - 6, 2);
                case HandType.RoyalFlush:
                    ...
                    this._binomialTheoremCalculator.
                        CalculateBinomialCoefficient(numSuits * numRanks - 5, 2);
            }
        ...
        )
        {
            return
                ...
                + (2 * this._binomialTheoremCalculator
                    .CalculateBinomialCoefficient(numRanks - 6, 2)
                + (numRanks - 5) * this._binomialTheoremCalculator
                    .CalculateBinomialCoefficient(numRanks - 7, 2));
        }
        private double CalculateNumberOfWaysToGetAtLeastFiveConsecutiveRanksFromSixDistinctRanks(int numRanks)
        {
        ...
        )
        {
            ...
            return this._binomialTheoremCalculator.CalculateBinomialCoefficient(5, 2)
                ...
                * Math.Pow(numSuits, 3)
                ...
                + this._binomialTheoremCalculator
                .CalculateBinomialCoefficient(numSuits, 2) * 2 * (numSuits - 2)
                * (Math.Pow(numSuits, 3) - 1)
                // 2 overlapping suits in 2 pairs
                + this._binomialTheoremCalculator
                .CalculateBinomialCoefficient(numSuits, 2)
                * (Math.Pow(numSuits, 3) - 2)
                );
        }
    }
}
